...
public class DuplicateLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//9	Enter Email
		driver.findElement(By.name("emailAddress")).sendKeys("pradeepa@gmail.com");
		...
		String text2 = driver.findElement(By.xpath("//div[@class='x-grid3-cell-inner x-grid3-col-lastName']/a"))
				.getText();
		System.out.println("First Name of resulting Lead is: "+text);
		System.out.println("LastName of resulting Lead is: "+text2);
