...
public class SalesForce {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@name='UserFirstName']")).sendKeys("Pradeepa");
		driver.findElement(By.xpath("//input[@name='UserLastName']")).sendKeys("Ganga");
		driver.findElement(By.xpath("//input[@name='UserEmail']")).sendKeys("pradeepaganga@gmail.com");
		...
		driver.findElement(By.xpath("//input[@name='UserPhone']")).sendKeys("9566053014");
